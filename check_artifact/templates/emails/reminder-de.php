<?php
/**
 * Email Template: Appointment Reminder (German)
 * 
 * Available variables:
...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
    <h2 style="color: #2a9d8f;">⏰ Terminerinnerung</h2>
    ...
    <div style="background: #fff3cd; padding: 20px; border-radius: 8px; margin: 20px 0; border-left: 4px solid #ffc107;">
        ...
        <p style="margin: 10px 0 0; font-size: 20px;">
            <strong><?php echo esc_html( $formatted_date ); ?> um <?php echo esc_html( $formatted_time ); ?> Uhr</strong>
        </p>
    </div>
    
    <p>Falls Sie den Termin verschieben oder absagen müssen, bitte rechtzeitig bescheid geben:</p>
    ...
    <p style="margin-top: 30px;">Wir freuen uns auf Sie!<br>Ihr Ocean Shiatsu Team</p>
</body>
</html>
